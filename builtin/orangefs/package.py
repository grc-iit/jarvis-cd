...
class Orangefs(Application):
    ...
    def _DefineInit(self):
        ...
        pvfs_gen_cmd.append(f"--storage {os.path.join(self.config['SERVER']['STORAGE_DIR'],'data')}")
        pvfs_gen_cmd.append(f"--metadata {os.path.join(self.config['SERVER']['STORAGE_DIR'],'meta')}")
        pvfs_gen_cmd.append(f"--logfile {os.path.join(self.config['SERVER']['STORAGE_DIR'],'orangefs.log')}")
