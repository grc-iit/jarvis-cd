...
cp /tmp/deepdrivemd-selfcfg.patch /opt/DeepDriveMD/deepdrivemd-selfcfg.patch
cd /opt/DeepDriveMD \
...
cp /tmp/deepdrivemd.template.yaml /opt/deepdrivemd.template.yaml
cp /tmp/run_ddmd.sh /opt/run_ddmd.sh
