...
## 0. Data Preparation
You should prepare at least one dataset to run the script. \
...
Create a Jarvis pipeline with ARLDM. `runtest` is a required parameter, depending on which input you prepared, use the particular dataset name you downloaded
```bash
